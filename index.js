...
const PORT = 5700
let allUsers = []
let URI = "mongodb+srv://ikolabaolanrewaju:olanrewaju09@cluster0.3jaoi.mongodb.net/Jumia_database?retryWrites=true&w=majority&appName=Cluster0"
...
app.get("/dashboard", (req, res)=>{
    res.render("dashboard", {name: "kunle", gender: "male", allUsers})
})
